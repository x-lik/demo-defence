...
event.syncRegister(UnitClass, "unitImmuneInvincible", function(evtData)
...
event.syncRegister(UnitClass, "unitImmuneDefend", function(evtData)
    mtg.model({
...
event.syncRegister(UnitClass, "unitImmuneEnchant", function(evtData)
    mtg.model({
